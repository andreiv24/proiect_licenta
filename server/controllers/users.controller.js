...
const usersController = {
    ...
    async updateUserEmail(req,res,next){
        try{
            ...
            await emailService.changedEmail(user.email,user);
    ...
    async verifyAccount(req,res,next){
        try{
            ...
            if (!user) throw new ApiError(httpStatus.NOT_FOUND,'Utilizatorul nu a fost găsit');
            if (user.verificat) throw new ApiError(httpStatus.BAD_REQUEST, 'Utilizator deja verificat');
            user.verificat = true;
            user.save();
